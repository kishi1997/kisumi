...
<main id="page-recruit" class="page-recruit">
            ...
            <div class="recruit-data-grid">
                <div class="recruit-data-card">
                    <div class="recruit-data-card__fig">
                        <img src="<?php bloginfo('template_url');?>/img/recruit-culture-workspace.jpg" alt="数字で見る季住">
                    </div>
                ...
                <div class="recruit-data-card">
                    <div class="recruit-data-card__fig">
                        <img src="<?php bloginfo('template_url');?>/img/recruit-schedule-room.jpg" alt="数字で見る季住">
                    </div>
                    <div class="recruit-data-card__body">
                ...
                <div class="recruit-data-card">
                    <div class="recruit-data-card__fig">
                        <img src="<?php bloginfo('template_url');?>/img/recruit-staff-portrait.jpg" alt="数字で見る季住">
                    </div>
                    <div class="recruit-data-card__body">
    ...
    <section class="recruit-culture">
        ...
        <div class="recruit-culture__img">
            <img src="<?php bloginfo('template_url');?>/img/recruit-culture-workspace.jpg" alt="風土">
        </div>
    </section>
    ...
    <section class="recruit-ideal">
        <div class="recruit-ideal__img">
            <img src="<?php bloginfo('template_url');?>/img/recruit-ideal-staircase.jpg" alt="求める人">
        </div>
            ...
            <div class="recruit-staff-grid">
                ...
                <div class="recruit-staff-card">
                    <div class="recruit-staff-card__img-wrap">
                        <img src="<?php bloginfo('template_url');?>/img/recruit-staff-portrait.jpg" alt="スタッフ紹介">
                    </div>
