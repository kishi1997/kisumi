    ...
    <section class="inner-section inner-section--neutral">
        <div class="inner-section__inner">
            ...
            <div class="about-region">
                ...
                <div class="about-region-item">
                    <div class="img-ph-wrapper">
                        <img class="img-ph" src="<?php bloginfo('template_url');?>/img/top-link-region.jpg" alt="みんなが笑顔になる「八方良し」の精神">
                    </div>
                    <div class="about-region-item__overlay">
    ...
    <section class="about-consult-cta">
        <div class="about-consult-cta__inner">
            ...
            <p class="about-consult-cta__lead">
                家づくりやリノベーションの第一歩は、あなたがこれからどんな時間を積み重ねていきたいか、そのささやかな理想やお悩みをお聞かせいただくことから始まります。
                季住デザインでは、土地探しや資金計画のご相談、素材感やデザインを実際に体感していただける見学会・イベントを定期的に開催しています。
                「まだ何も決まっていない」「新築かリノベかも迷っている」という方も大歓迎です。どうぞ安心してお気軽にお越しください。
            </p>
